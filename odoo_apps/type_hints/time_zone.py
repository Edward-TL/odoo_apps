...
Tz = Literal[
    ...
    'Cuba', 'EET', 'EST', 'EST5EDT', 'Egypt', 'Eire', 'Europe/Amsterdam', 'Europe/Andorra',
    'Europe/Astrakhan',
    ...
    'GMT-0', 'GMT0', 'Greenwich', 'HST', 'Hongkong', 'Iceland', 'Indian/Antananarivo',
    ...
    'Pacific/Wallis', 'Pacific/Yap', 'Poland', 'Portugal', 'ROC', 'ROK', 'Singapore',
    ...
    'US/Samoa', 'UTC', 'Universal', 'W-SU', 'WET', 'Zulu', 'Etc/GMT', 'Etc/GMT+0', 'Etc/GMT+1',
